...
@class SubMusicListAlbumModel,SubMusicListTracksModel,SubMusicListTracksListModel;
@interface SubMusicListModel : BaseModel

@property (nonatomic, strong) SubMusicListTracksModel *tracks;

@property (nonatomic, strong) SubMusicListAlbumModel *album;

@property (nonatomic, copy) NSString *msg;

@property (nonatomic, assign) NSInteger ret;
@end
@interface SubMusicListAlbumModel : NSObject
...
@interface SubMusicListTracksModel : NSObject

@property (nonatomic, assign) NSInteger maxPageId;

@property (nonatomic, strong) NSArray<SubMusicListTracksListModel *> *list;
...
@interface SubMusicListTracksListModel : NSObject
